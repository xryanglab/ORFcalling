...
"""
PCG_SAMPLE_NUM = 1000
MIN_COUNTS = 100 # for selecting the genes 
accept_length = set([28,30]) # P-sites used for ORF calling
gtfFile = "/workdata/DataBase/GRCh38R24/gencode.v24.primary_assembly.annotation.gtf"
bamFile1 = "/workdata/LabMember2/xiao/ORFscore_ExternalData/PP242/star_remove/rpf_control1Aligned.sortedByCoord.out.bam"
bamFile2 = "/workdata/LabMember2/xiao/ORFscore_ExternalData/PP242/star_remove/mRNA_control1Aligned.sortedByCoord.out.bam"
star_counts_file = '/workdata/LabMember2/xiao/ORFscore_ExternalData/PP242/star_remove/rpf_control1ReadsPerGene.out.tab'
...
with open("filter_genes.gtf","w") as fout, open(gtfFile) as fin:
	for line in fin:
		if line.startswith("#"): continue
		field_dict = parsing_line(line)
...
select_bed = BedTool("filter_genes.gtf")
